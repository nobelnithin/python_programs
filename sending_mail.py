...
smtp.login('nithinnithun2812@gmail.com', 'Nithinnisvi@20012001')


# send our email message 'msg' to our boss
def message(subject="Alert Notification!!!",
			text="Hi I can send message", img=None,
			attachment=None):
	...
	if attachment is not None:
		...
		if type(attachment) is not list:
			...
			# if it isn't a list, make it one
			attachment = ["C:\\Users\\Nithin\\Pictures\\Saved Pictures\\sun_flower.jpg"]
...
to = ["msdrahul6090@gmail.com",
	"fenin2003@gmail.com", "nithinnithin2812@gmail.com"]
